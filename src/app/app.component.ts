...
export class AppComponent {
  ...
  linkedin: string =
    'https://www.linkedin.com/in/fafowora-oluwatobiloba-950091167/';
  ...
  workPositions: Array<WorkHistory> = [
    {
      work: 'TenantPro',
      workDetails: {
        position: 'Backend Developer [GIG]',
        timeSpent: 'January-2024 - January-2025',
        workDone: [
          "Engineered a modular REST API backend for a proptech platform, covering end-to-end rental operations across tenancy, referencing, maintenance, payments, invoicing, and dashboards.",
          "Designed and maintained a complex relational data layer with Sequelize/MySQL (80+ domain models), including audit/history tracking for key business entities.",
          "Implemented secure auth flows (JWT + refresh token lifecycle with Redis), environment-scoped token validation, and role/permission controls for multi-tenant access.",
          "Built payment workflows including payment requests, hosted checkout sessions, and transaction history using Stripe; integrated account/payment rails and webhook handling for Modulr.",
          "Developed tenancy and finance automation: recurring invoice creation, due-date processing, reminders, and invoice PDF download workflows.",
          "Integrated document and communication services using AWS S3 (file storage) and SES (transactional emails), supporting onboarding, offers, maintenance, and tenancy notifications.",
          "Added robust input validation with Zod across API endpoints to improve data integrity and reduce invalid request handling in controllers.",
          "Contributed to release engineering with GitLab CI/CD pipelines and EC2/PM2 deployment flow for staging/production environments."
        ],
      },
    },
    {
      ...
      workDetails: {
        ...
        timeSpent: 'April-2022 - December-2024',
        workDone: [
  ...
  myProjects: Array<Project> = [
    {
      ...
      projectDescription:
        'A web application that generates seating arrangements for an unlimited number of students in ' +
    ...
    },
    {
      ...
      projectDescription:
        'A food store application that integrates with the Stripe API to enable users to track their daily ' +
    ...
    },
    {
      ...
      projectDescription:
        'An all-in-one HR solution that helps organization with all their HR needs such as payroll, leave, ' +
    ...
    {
      projectName: 'TenantPro',
      projectDescription:
        'Built and maintained a large-scale, multi-module property management backend powering workflows for agents, ' +
        'landlords, tenants, contractors, and back-office teams. The platform centralizes the full rental lifecycle: user ' +
        'onboarding and access control, property and tenancy management, referencing and credit checks, offers and viewings, ' +
        'maintenance/work orders, rent billing, invoice generation, payment collection, and operational dashboards.',
      link: 'https://www.tenantpro.net/',
    },
    {
      projectName: 'ExaltCourier',
      projectDescription:
        'An app that goes where no other logistics app has ever gone before. It offers a seamless way for you to manage all ' +
